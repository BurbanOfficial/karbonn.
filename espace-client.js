  ...
  return `
    <div class="document-card">
      ...
      <div class="document-card-actions">
        ${doc.type === 'invoice' && doc.status === 'unpaid' && doc.payPending && doc.payToken
          ? `<a class="btn-doc-pay btn-doc-track" href="https://pay.karbonn.fr/?t=${encodeURIComponent(doc.payToken)}"><i class="fa-solid fa-clock"></i> Suivre mon paiement</a>`
